...
- [x] Repair and validate the physical PVC card showcase, reusable 3D admin preview, and rotatable interactions
...
- [ ] Pair each rotating card with its matching live hub in the homepage hero, extend admin management, optimize loading/cycle timing, and provide desktop/mobile/recording evidence
