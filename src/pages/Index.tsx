      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <a
              href="/paywall"
              className="block w-full py-3 rounded-lg border border-border text-center font-semibold text-sm hover:bg-muted transition-colors"
            >
              Get Started
            </a>
          </motion.div>
      ...
      <nav className="sticky top-0 z-30 bg-white/90 backdrop-blur-lg border-b border-border">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex justify-between items-center py-2.5">
            ...
            {user ? (
              <a href="/dashboard" className="px-4 py-2 rounded-lg font-bold text-sm bg-foreground text-background">
                Dashboard
              </a>
            ) : (
              <a href="/paywall" className="px-4 py-2 rounded-lg font-bold text-sm bg-foreground text-background">
                Get Started
              </a>
            )}
          </div>
