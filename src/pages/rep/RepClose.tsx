...
const PLAN_OPTIONS = [
  {
    id: 'venue_annual',
    name: 'Venue Pack Annual',
    price: '$390/yr',
    commission: '$60 upfront + $40/yr recurring',
    points: '1 pt',
    tag: 'Best Value',
  },
  {
    id: 'venue_monthly',
    name: 'Venue Pack Monthly',
    price: '$39/mo',
    commission: '$30 upfront + $4/mo recurring',
    points: '1 pt',
    tag: null,
  },
  {
    id: 'solo_annual',
    name: 'Solo Pro Annual',
    price: '$150/yr',
    commission: '$25 upfront + $15/yr recurring',
    points: '0.5 pts',
    tag: null,
  },
  {
