            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{yearlyPlan.description}</p>
                </div>
                ...
                {isPromoActive && timeRemaining && (
                  <div className="flex items-center gap-2 text-sm font-medium text-primary">
                    ...
                    <span>
                      Deal ends in: {timeRemaining.days}d {timeRemaining.hours}h {timeRemaining.minutes}m {timeRemaining.seconds}s
                    </span>
                  </div>
                )}
