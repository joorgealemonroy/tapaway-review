...
const shareOptions = [
  ...
  { 
    ...
    label: 'Snapchat', 
    icon: () => (
      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current text-black">
        <path d="M12 2C9.3 2 7.4 3.4 6.8 5.5c-.3 1-.2 2.2-.1 3.4v.3c-.2 0-.5-.1-.8-.1-.4 0-.8.1-1.1.4-.3.3-.5.7-.4 1.1.1.5.5.9 1 1.1.2.1.4.1.5.2-.1.3-.2.7-.3 1-.1.5-.2 1 .1 1.4.2.3.5.5.8.6.2.1.4.1.5.2-.1.2-.2.5-.2.8 0 .4.2.8.5 1.1.4.4 1 .6 1.5.7.3.1.6.1.8.2.1.1.1.1.1.2.3.5.7.9 1.2 1.2.6.4 1.4.6 2.1.6s1.5-.2 2.1-.6c.5-.3.9-.7 1.2-1.2 0-.1.1-.1.1-.2.2-.1.5-.1.8-.2.6-.1 1.1-.3 1.5-.7.3-.3.5-.7.5-1.1 0-.3-.1-.6-.2-.8.2-.1.4-.1.5-.2.3-.1.6-.3.8-.6.3-.4.2-.9.1-1.4-.1-.3-.2-.7-.3-1 .2-.1.3-.1.5-.2.5-.2.9-.6 1-1.1.1-.4-.1-.8-.4-1.1-.3-.3-.7-.4-1.1-.4-.3 0-.6.1-.8.1v-.3c.1-1.2.2-2.4-.1-3.4C16.6 3.4 14.7 2 12 2z"/>
      </svg>
    ),
    color: 'bg-[#FFFC00]',
    action: 'snapchat'
  ...
  if (isMobile) {
    return (
      <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
        <DrawerContent className="bg-zinc-900 border-zinc-800 rounded-t-3xl max-h-[90vh] [&>div:first-child]:hidden">
