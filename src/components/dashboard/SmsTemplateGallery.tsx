...
export const SMS_TEMPLATES: SmsTemplate[] = [
  {
    ...
    icon: Star,
    body: "Loved your visit to {businessName}? Tap here to leave us a quick review - it means the world to our team: {hubLink}",
  },
  {
    id: "slow-day-deal",
    ...
    icon: Zap,
    body: "Slow day? {businessName} has a flash deal today only - show this text to claim it: {hubLink}",
  },
  {
    id: "new-item",
    ...
    icon: Sparkles,
    body: "New at {businessName}! Try our latest addition - check it out here: {hubLink}",
  },
  {
    id: "event-reminder",
    name: "Event reminder",
    ...
    icon: CalendarDays,
    body: "Reminder from {businessName}: our event is coming up! Details here: {hubLink}",
  },
  {
    id: "holiday-greeting",
    ...
    icon: Heart,
    body: "Happy holidays from the {businessName} crew! Thanks for supporting us this year - see what's on: {hubLink}",
  },
  {
    id: "win-back",
    name: "We miss you",
    ...
    icon: Gift,
    body: "We miss you at {businessName}! It's been a while - come see what's new: {hubLink}",
  },
  {
    id: "announcement",
    ...
    icon: Megaphone,
    body: "Big news from {businessName}! We've got something exciting to share - get the details here: {hubLink}",
  },
];
