...
export const AnalyticsOverview = ({ restaurantId }: AnalyticsOverviewProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Total Taps (7 days)</p>
              <p className="text-3xl font-bold mt-2">{analytics.totalTaps}</p>
            </div>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-semibold mt-2">{analytics.mostClicked}</p>
            </div>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-semibold mt-2">{analytics.peakDay}</p>
            </div>
      ...
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Button Performance</h3>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="text-center">
            <Star className="w-6 h-6 mx-auto text-primary mb-2" />
            <p className="text-2xl font-bold">{analytics.googleClicks}</p>
            <p className="text-sm text-muted-foreground">Google Reviews</p>
          </div>
          <div className="text-center">
            <Star className="w-6 h-6 mx-auto text-destructive mb-2" />
            <p className="text-2xl font-bold">{analytics.yelpClicks}</p>
            <p className="text-sm text-muted-foreground">Yelp</p>
          </div>
          <div className="text-center">
            <Instagram className="w-6 h-6 mx-auto text-primary mb-2" />
            <p className="text-2xl font-bold">{analytics.instagramClicks}</p>
            <p className="text-sm text-muted-foreground">Instagram</p>
          </div>
          <div className="text-center">
            <MapPin className="w-6 h-6 mx-auto text-primary mb-2" />
            <p className="text-2xl font-bold">{analytics.directionsClicks}</p>
            <p className="text-sm text-muted-foreground">Directions</p>
          </div>
          <div className="text-center">
            <Menu className="w-6 h-6 mx-auto text-foreground mb-2" />
            <p className="text-2xl font-bold">{analytics.menuViews}</p>
