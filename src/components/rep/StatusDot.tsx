export const PIPELINE_STATUSES = [
  ...
  { value: 'approved',          label: 'Approved · Awaiting Print', dot: 'bg-emerald-400', ring: 'ring-emerald-400/30' },
  { value: 'card_ready',        label: 'NFC Card Printed',          dot: 'bg-amber-400',   ring: 'ring-amber-400/30' },
  { value: 'activated',         label: 'Card Activated',            dot: 'bg-teal-400',     ring: 'ring-teal-400/30' },
