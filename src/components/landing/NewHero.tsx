...
export const NewHero = () => {
  return <section className="bg-[#0B1220] flex items-center justify-center px-4 pt-28 pb-16 md:pt-32 md:pb-20 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        delay: 0.5
          ...
          $20/mo Solo · $39/mo Venue · or $199/yr & $390/yr · 14-day free trial
        </motion.p>
