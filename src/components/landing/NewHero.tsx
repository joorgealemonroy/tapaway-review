...
export const NewHero = () => {
  return (
    <section className="min-h-[85vh] bg-[#0B1220] flex items-center justify-center px-4 py-12 md:py-16 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          <motion.a
            href="/paywall"
            className="inline-flex items-center px-7 py-3.5 rounded-full font-bold bg-primary text-primary-foreground shadow-[0_0_30px_rgba(11,165,164,0.35)] text-base"
            whileHover={{ scale: 1.03, boxShadow: "0 0 50px rgba(11,165,164,0.5)" }}
            whileTap={{ scale: 0.98 }}
          >
