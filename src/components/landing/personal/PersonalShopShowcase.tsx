...
import { DollarSign, ShoppingBag, Instagram, Twitter, Youtube, Music, ExternalLink } from "lucide-react";
...
const PersonalShopShowcase = () => {
  ...
  return (
    <section className="relative py-20 px-4 overflow-hidden" style={{ background: "hsl(213, 35%, 8%)" }}>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="relative max-w-lg mx-auto" style={{ minHeight: 520 }}>
          {/* Profile Card — center */}
          <motion.div
            className="relative z-10 mx-auto w-72 rounded-3xl p-6 space-y-4"
          ...
          {/* Revenue card — floating top-right */}
          <motion.div
            className="absolute z-20 right-0 md:-right-8 top-4 w-44 rounded-2xl p-4 shadow-2xl"
            style={{ background: "hsl(var(--primary))", rotate: "4deg" }}
          ...
          >
            ...
            <p className="text-primary-foreground text-2xl font-extrabold">$1,536</p>
            <p className="text-primary-foreground/60 text-[10px] mt-0.5">+$240 this week</p>
          </motion.div>

          {/* Product card — floating bottom-left */}
          <motion.div
            className="absolute z-20 left-0 md:-left-8 bottom-8 w-48 rounded-2xl overflow-hidden shadow-2xl"
            style={{ background: "hsl(0, 0%, 100%)", rotate: "-3deg" }}
            initial={{ opacity: 0, x: -30, y: 10 }}
            whileInView={{ opacity: 1, x: 0, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="p-3 space-y-1.5">
              <p className="text-foreground text-sm font-semibold leading-tight">Social Media Starter Kit</p>
              <p className="text-muted-foreground text-xs">50+ templates</p>
              <div className="flex items-center justify-between pt-1">
                <span className="text-foreground font-bold text-sm">$9.99</span>
