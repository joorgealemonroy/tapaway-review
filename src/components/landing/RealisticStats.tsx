...
const stats = [
  { emoji: "✅", value: "3", label: "Active Restaurant Locations" },
  { emoji: "⭐", value: "120+", label: "Reviews Generated with TapAway" },
  { emoji: "🔥", value: "100%", label: "of TapAway reviews are 5-star" },
  { emoji: "⚡", value: "Same-week", label: "results reported by all clients" },
];
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <span className="text-xs text-gray-400">
            Live reviews coming in from California restaurants right now
          </span>
        </motion.div>
      </div>
    </section>
