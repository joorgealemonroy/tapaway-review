...
REVOKE SELECT ON public.personal_profiles FROM anon;

-- Recreate the public view WITHOUT security_invoker so it uses the view owner's
-- privileges (matching the original design) and exposes only whitelisted columns.
